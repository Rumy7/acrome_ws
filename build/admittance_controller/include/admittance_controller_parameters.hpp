#pragma message("#include \"admittance_controller_parameters.hpp\" is deprecated. Use #include <admittance_controller/admittance_controller_parameters.hpp> instead.")
  ...
  public:
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "chainable_command_interfaces")) {
          ...
          descriptor.read_only = true;
          auto parameter = to_parameter_value(updated_params.chainable_command_interfaces);
