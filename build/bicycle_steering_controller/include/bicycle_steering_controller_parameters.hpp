#pragma message("#include \"bicycle_steering_controller_parameters.hpp\" is deprecated. Use #include <bicycle_steering_controller/bicycle_steering_controller_parameters.hpp> instead.")
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
    ...
    struct Params {
        ...
        double traction_wheel_radius = 0.0;
  ...
  public:
    ...
    StackParams get_stack_params() {
      ...
      output.traction_wheel_radius = params.traction_wheel_radius;
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        ...
        if (param.get_name() == (prefix_ + "traction_wheel_radius")) {
            updated_params.traction_wheel_radius = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "traction_wheel_radius")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Traction wheel radius.";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.traction_wheel_radius);
          parameters_interface_->declare_parameter(prefix_ + "traction_wheel_radius", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "front_wheel_radius")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "DEPRECATED: Use 'traction_wheel_radius'";
      ...
      updated_params.wheelbase = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "traction_wheel_radius");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.traction_wheel_radius = param.as_double();
