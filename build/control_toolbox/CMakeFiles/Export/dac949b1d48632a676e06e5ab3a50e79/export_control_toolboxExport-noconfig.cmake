...
set_target_properties(control_toolbox::rate_limiter PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/librate_limiter.so"
  IMPORTED_SONAME_NOCONFIG "librate_limiter.so"
  )
...
set_target_properties(control_toolbox::exponential_filter PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libexponential_filter.so"
  IMPORTED_SONAME_NOCONFIG "libexponential_filter.so"
  )
...
# Import target "control_toolbox::gravity_compensation" for configuration ""
set_property(TARGET control_toolbox::gravity_compensation APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(control_toolbox::gravity_compensation PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libgravity_compensation.so"
  IMPORTED_SONAME_NOCONFIG "libgravity_compensation.so"
  )

list(APPEND _cmake_import_check_targets control_toolbox::gravity_compensation )
list(APPEND _cmake_import_check_files_for_control_toolbox::gravity_compensation "${_IMPORT_PREFIX}/lib/libgravity_compensation.so" )
