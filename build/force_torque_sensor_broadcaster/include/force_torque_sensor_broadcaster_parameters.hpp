...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    StackParams get_stack_params() {
      ...
      output.multiplier.force.x = params.multiplier.force.x;
      output.multiplier.force.y = params.multiplier.force.y;
      output.multiplier.force.z = params.multiplier.force.z;
      output.multiplier.torque.x = params.multiplier.torque.x;
      output.multiplier.torque.y = params.multiplier.torque.y;
      output.multiplier.torque.z = params.multiplier.torque.z;
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        ...
        if (param.get_name() == (prefix_ + "multiplier.force.x")) {
            updated_params.multiplier.force.x = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "multiplier.force.y")) {
            updated_params.multiplier.force.y = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "multiplier.force.z")) {
            updated_params.multiplier.force.z = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "multiplier.torque.x")) {
            updated_params.multiplier.torque.x = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "multiplier.torque.y")) {
            updated_params.multiplier.torque.y = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
        if (param.get_name() == (prefix_ + "multiplier.torque.z")) {
            updated_params.multiplier.torque.z = param.as_double();
            RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
        }
      }
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "multiplier.force.x")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "The multiplier of force value on 'x' axis.";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.multiplier.force.x);
          parameters_interface_->declare_parameter(prefix_ + "multiplier.force.x", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "multiplier.force.y")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "The multiplier of force value on 'y' axis.";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.multiplier.force.y);
          parameters_interface_->declare_parameter(prefix_ + "multiplier.force.y", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "multiplier.force.z")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "The multiplier of force value on 'z' axis.";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.multiplier.force.z);
          parameters_interface_->declare_parameter(prefix_ + "multiplier.force.z", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "multiplier.torque.x")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "The multiplier of torque value around 'x' axis.";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.multiplier.torque.x);
          parameters_interface_->declare_parameter(prefix_ + "multiplier.torque.x", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "multiplier.torque.y")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "The multiplier of torque value around 'y' axis.";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.multiplier.torque.y);
          parameters_interface_->declare_parameter(prefix_ + "multiplier.torque.y", parameter, descriptor);
      }
      if (!parameters_interface_->has_parameter(prefix_ + "multiplier.torque.z")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "The multiplier of torque value around 'z' axis.";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.multiplier.torque.z);
          parameters_interface_->declare_parameter(prefix_ + "multiplier.torque.z", parameter, descriptor);
      }
      ...
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.offset.torque.z = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.force.x");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.force.x = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.force.y");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.force.y = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.force.z");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.force.z = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.torque.x");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.torque.x = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.torque.y");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.torque.y = param.as_double();
      param = parameters_interface_->get_parameter(prefix_ + "multiplier.torque.z");
      RCLCPP_DEBUG_STREAM(logger_, param.get_name() << ": " << param.get_type_name() << " = " << param.value_to_string());
      updated_params.multiplier.torque.z = param.as_double();
