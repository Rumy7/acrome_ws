  ...
  public:
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "tf.publish_rate")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Rate to limit publishing of tf transforms to (Hz). If set to 0, no limiting is performed. This parameter is deprecated and limiting should not be performed.";
          descriptor.read_only = false;
