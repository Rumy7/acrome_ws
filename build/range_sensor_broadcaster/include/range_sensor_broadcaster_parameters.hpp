#pragma message("#include \"range_sensor_broadcaster_parameters.hpp\" is deprecated. Use #include <range_sensor_broadcaster/range_sensor_broadcaster_parameters.hpp> instead.")
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    StackParams get_stack_params() {
      ...
      output.variance = params.variance;
    ...
    rcl_interfaces::msg::SetParametersResult update(const std::vector<rclcpp::Parameter> &parameters) {
      ...
      for (const auto &param: parameters) {
        ...
        if (param.get_name() == (prefix_ + "variance")) {
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "variance")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Variance of the range value";
          descriptor.read_only = false;
          auto parameter = to_parameter_value(updated_params.variance);
          parameters_interface_->declare_parameter(prefix_ + "variance", parameter, descriptor);
      }
