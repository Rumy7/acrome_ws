#pragma message("#include \"tricycle_steering_controller_parameters.hpp\" is deprecated. Use #include <tricycle_steering_controller/tricycle_steering_controller_parameters.hpp> instead.")
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("tricycle_steering_controller"), prefix) {
    ...
    void declare_params(){
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "wheel_track")) {
          ...
          descriptor.description = "(deprecated) Axle track, use 'traction_track_width' instead";
      ...
      if (!parameters_interface_->has_parameter(prefix_ + "traction_track_width")) {
          rcl_interfaces::msg::ParameterDescriptor descriptor;
          descriptor.description = "Axle track";
          descriptor.read_only = false;
